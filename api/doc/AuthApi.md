...
final api_instance = AuthApi();
final loginRequest = InlineObject1(); // InlineObject1 | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **loginRequest** | [**InlineObject1**](InlineObject1.md)|  | [optional] 
...
final api_instance = AuthApi();
final signupRequest = InlineObject2(); // InlineObject2 | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **signupRequest** | [**InlineObject2**](InlineObject2.md)|  | [optional] 
